...
void bacaGPS() {
  ...
  sendMessage("Smart Necklace Sheep Aktif!\n"
              "Perangkat telah berhasil dinyalakan dan siap memantau ternak.\n\n"
              "Perintah apa yang Anda inginkan?\n\n"
              "/kirimlokasi untuk mengirim lokasi GPS\n"
              "/cekkondisi untuk mengecek apakah terdapat guncangan pada accelerometer");
}
